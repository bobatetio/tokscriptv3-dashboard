...
function WhatYouCanDoSection() {
  ...
  const PromptBaseMockup = () => (
    <div className="rounded-2xl p-5 flex flex-col gap-3" style={{ background: cardBg, border: `1px solid ${border}` }}>
      ...
      {[
        ...
        { title: 'Instagram Carousel',         category: 'Repurpose', desc: 'Turn a transcript into a swipe-worthy 10-slide carousel.',      uses: '4.1K' },
      ].map((p) => (
  ...
  const features = [
    ...
    },
    {
      ...
      bullets: ['50+ prompts across 7 categories — Hooks, Repurpose, SEO, and more', 'Apply any prompt directly to your transcript with one click', 'Community-powered: sorted by real usage counts and verified results', 'From viral hooks to email newsletters, Instagram carousels, and full scripts'],
