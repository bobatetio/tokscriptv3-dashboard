...
export const PROMPTS: Prompt[] = [
  ...
  {
    id: 2, category: 'Repurpose', featured: true, uses: 6170,
    title: 'LinkedIn Thread Converter',
    description: 'Convert a video transcript into a high-performing LinkedIn carousel or text thread.',
    tags: ['LinkedIn', 'B2B', 'Thread'],
    prompt: `You are a B2B LinkedIn content expert who has helped dozens of thought leaders grow to 50,000+ followers. Your task is to transform the transcript below into a high-performing 7-part LinkedIn text thread.\n\nLINKEDIN ALGORITHM CONTEXT:\n- LinkedIn rewards posts that generate dwell time, comments, and reposts\n- The first post must hook well enough that someone taps "see more"\n- Short paragraphs (1–2 sentences) outperform walls of text\n- Line breaks every 1–2 sentences dramatically improve readability on mobile\n- Ending posts with a question drives comment rate significantly\n- The final CTA should be specific, not generic ("Share this with your team" beats "Follow me")\n\nSTRUCTURE FOR ALL 7 POSTS:\n\nPost 1 — THE HOOK POST\n- Open with a bold claim, surprising stat, or contrarian take from the transcript\n- Do NOT use "I" as the first word — LinkedIn suppresses these algorithmically\n- End with a blank line then: "Here's what I mean: 🧵 (1/7)"\n- Max 3 sentences before the thread label\n\nPosts 2–6 — BODY POSTS (one distinct insight each)\n- Open each with a hook sentence that stands alone even out of context\n- Use line breaks between every 1–2 sentences\n- End each with a natural pull to the next post: "(N/7) 👇"\n- Max 180 words per post\n\nPost 7 — THE CTA POST\n- Summarise the 3 most important takeaways in bullet points\n- Add a personal reflection or forward-looking insight\n- End with: a direct question to the reader + a CTA (follow, share, or reply)\n- Include "(7/7)" and a relevant emoji\n\nFORMATTING RULES:\n- Write in first person, conversational tone throughout\n- No corporate jargon — write like a smart, opinionated human\n- Use line breaks generously between every thought\n- Include 1–2 relevant emojis per post (never more)\n- No hashtags anywhere in the thread\n\nTranscript:\n[TRANSCRIPT]`,
  },
  {
  ...
  { id: 17, category: 'Repurpose', featured: true, uses: 5020, title: 'Twitter/X Thread (10 posts)', description: 'Transform a transcript into a tightly-crafted 10-post Twitter/X thread built for engagement.', tags: ['Twitter/X', 'Thread', 'Virality'], prompt: `You are a Twitter/X growth strategist who has built multiple accounts past 100k followers through high-quality educational threads. Your task is to transform the transcript below into a 10-post thread optimised for maximum engagement, shares, and follows.\n\nWHAT MAKES A GREAT THREAD:\n- Post 1 must perform as a standalone viral tweet — if it doesn't hook, nobody reads further\n- Each post should deliver ONE complete, self-contained idea\n- Posts 2–9 should each be retweetable in isolation — this multiplies reach exponentially\n- Avoid "thread 🧵" labels, long intros, or "let's get into it" — waste of characters\n- Vary your format: stats, quotes, numbered lists, questions, bold claims\n- Post 10 is your follow-funnel — make it earn the follow\n\nTHREAD STRUCTURE:\n\nPOST 1 — THE HOOK (standalone viral tweet)\n- Open with the most surprising, bold, or useful claim from the transcript\n- Do NOT start with "I" — algorithmic suppression on X\n- Do NOT use "Thread 🧵" as the opener — signals low quality\n- Max 240 characters\n- Must be worth retweeting as a single tweet, with no context\n\nPOSTS 2–4 — THE FOUNDATION\n- Establish context, define terms, lay the groundwork\n- Mix: 1 stat-based post, 1 story/example post, 1 contrast/comparison post\n- Each max 240 characters\n- End each with irresistible momentum (not a CTA — just make them need the next post)\n\nPOSTS 5–7 — THE MEAT\n- The most valuable, specific, actionable insights from the transcript\n- Use a numbered list for at least one: "3 things I learned:" or "The real reason X:"\n- Each can be up to 280 characters\n\nPOSTS 8–9 — THE TURNING POINT\n- The most surprising, counter-intuitive, or emotionally resonant moments\n- These should feel like the "reveal" of the thread — make the reader pause\n\nPOST 10 — THE CLOSER\n- 3-bullet summary of the thread's key ideas\n- One sentence of personal reflection\n- Direct question to the reader (drives comments)\n- Follow CTA: "Follow me for [specific value prop] — I post [frequency]."\n\nFORMATTING RULES:\n- No hashtags in any post\n- Plain language — no jargon, no corporate speak\n- Short sentences, line breaks between ideas for scanner readability\n- Include "(N/10)" at the end of each post\n- Max 1 emoji per post — only where it genuinely adds meaning\n\nOUTPUT ALL 10 POSTS IN SEQUENCE, CLEARLY LABELLED.\n\nTranscript:\n[TRANSCRIPT]` },
