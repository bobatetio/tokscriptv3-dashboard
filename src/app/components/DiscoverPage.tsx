  ...
  return (
    ...
    >
      ...
      <div className="flex-shrink-0 flex items-end flex-col" style={{ width: 80 }}>
        <span className="text-[11px]" style={{ color: text }}>{formatCardDate(entry.date)}</span>
      </div>
