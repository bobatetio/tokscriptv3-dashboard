...
export default function Frame() {
  return (
    <div className="bg-[#0d0d0d] border border-[#262626] border-solid overflow-clip relative rounded-[10px] size-full">
      <div className="absolute flex h-[666.265px] items-center justify-center left-[-70.83px] top-[-421.63px] w-[935.66px]" style={{ "--transform-inner-width": "1200", "--transform-inner-height": "19" } as React.CSSProperties}>
