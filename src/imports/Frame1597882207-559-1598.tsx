...
export default function Frame() {
  return (
    <div className="bg-[#0d0d0d] border border-[#262626] border-solid overflow-clip relative rounded-[10px] size-full">
      <div className="-translate-x-1/2 -translate-y-1/2 absolute h-[215px] left-[calc(50%+5px)] opacity-20 top-[calc(50%-9.5px)] w-[834px]" data-name="Screenshot 2026-03-09 at 3.41.43 AM 1">
